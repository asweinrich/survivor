  ...
  return (
    <div className="bg-stone-900 text-stone-200 p-0 font-lostIsland min-h-screen">
      ...
      <div className="flex flex-col justify-center w-full p-4">
        ...
        <button disabled className="opacity-40 w-full p-3 text-2xl uppercase bg-gradient-to-tr from-orange-500 to-orange-700 hover:from-orange-600 hover:to-orange-800 rounded-lg text-white">
          Draft Your Tribe
        </button>
        </a>
      </div>
